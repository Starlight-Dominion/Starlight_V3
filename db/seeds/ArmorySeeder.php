...
class ArmorySeeder extends AbstractSeed {
    public function run(): void {
        $this->execute('SET FOREIGN_KEY_CHECKS=0;');
        $this->execute('TRUNCATE TABLE armory_items;');
        $this->execute('TRUNCATE TABLE armory_categories;');
        $this->execute('TRUNCATE TABLE armory_unit_types;');
        ...
        $loadouts = [
            'soldiers' => [
                ...
                'categories' => [
                    'main_weapon' => [
                        'title' => 'Heavy Main Weapons', 'slots' => 1,
                        'items' => [
            ...
            'guards' => [
                ...
                'categories' => [
                    'armor_suit' => [
                        'title' => 'Defensive Main Equipment (Armor Suits)', 'slots' => 1,
                        'items' => [
                    ...
                    'secondary_defense' => [
                        'title' => 'Defensive Side Devices (Secondary Defenses)', 'slots' => 1,
                        'items' => [
                    ...
                    'melee_counter' => [
                        'title' => 'Melee Countermeasures', 'slots' => 1,
                        'items' => [
                    ...
                    'defensive_headgear' => [
                        'title' => 'Head Gear (Defensive Helmets)', 'slots' => 1,
                        'items' => [
                    ...
                    'defensive_deployable' => [
                        'title' => 'Defensive Deployables', 'slots' => 1,
                        'items' => [
            ...
            'sentries' => [
                ...
                'categories' => [
                    'shields' => [
                        'title' => 'Defensive Main Equipment (Shields)', 'slots' => 1,
                        'items' => [
                    ...
                    'secondary_defensive_systems' => [
                        'title' => 'Secondary Defensive Systems', 'slots' => 1,
                        'items' => [
                    ...
                    'shield_bash' => [
                        'title' => 'Melee Countermeasures (Shield Bash)', 'slots' => 1,
                        'items' => [
                    ...
                    'helmets' => [
                        'title' => 'Defensive Headgear (Helmets)', 'slots' => 1,
                        'items' => [
                    ...
                    'fortifications' => [
                        'title' => 'Defensive Deployables (Fortifications)', 'slots' => 1,
                        'items' => [
            ...
            'spies' => [
                ...
                'categories' => [
                    'silenced_projectors' => [
                        'title' => 'Stealth Main Weapons (Silenced Projectors)', 'slots' => 1,
                        'items' => [
                    ...
                    'cloaking_disruption' => [
                        'title' => 'Cloaking & Disruption Devices', 'slots' => 1,
                        'items' => [
                    ...
                    'concealed_blades' => [
                        'title' => 'Melee Weapons (Concealed Blades)', 'slots' => 1,
                        'items' => [
                    ...
                    'intel_suite' => [
                        'title' => 'Spy Headgear (Intel Suite)', 'slots' => 1,
                        'items' => [
                    ...
                    'infiltration_gadgets' => [
                        'title' => 'Infiltration Gadgets', 'slots' => 1,
                        'items' => [
            ...
            'workers' => [
                ...
                'categories' => [
                    'mining_lasers_drills' => [
                        'title' => 'Utility Main Equipment (Mining Lasers & Drills)', 'slots' => 1,
                        'items' => [
                    ...
                    'resource_enhancement' => [
                        'title' => 'Resource Enhancement Tools', 'slots' => 1,
                        'items' => [
                    ...
                    'exo_rig_plating' => [
                        'title' => 'Defensive Gear (Exo-Rig Plating)', 'slots' => 1,
                        'items' => [
                    ...
                    'scanners' => [
                        'title' => 'Utility Headgear (Scanners)', 'slots' => 1,
                        'items' => [
                    ...
                    'drones' => [
                        'title' => 'Construction & Repair Drones', 'slots' => 1,
                        'items' => [
        ...
        foreach ($loadouts as $uSlug => $uData) {
            // armory_unit_types name is derived from slug for consistency
            $this->table('armory_unit_types')->insert(['slug' => $uSlug, 'name' => ucfirst($uSlug), 'title' => $uData['title']])->save();
            $utId = $adapter->getConnection()->lastInsertId();
            
            foreach ($uData['categories'] as $cSlug => $cData) {
                $this->table('armory_categories')->insert(['unit_type_id' => $utId, 'slug' => $cSlug, 'name' => $cData['title'], 'slots' => $cData['slots']])->save();
                $catId = $adapter->getConnection()->lastInsertId();
                
                foreach ($cData['items'] as $iSlug => $i) {
                    $this->table('armory_items')->insert([
                        'category_id' => $catId,
                        'slug' => $iSlug,
                        'name' => $i['name'],
                        'unit_type' => $uSlug,
                        'attack_bonus' => $i['attack'] ?? 0,
                        'defense_bonus' => $i['defense'] ?? 0,
                        'cost' => $i['cost'],
                        'requirement_slug' => $i['requires'] ?? null,
                        'armory_level_req' => $i['armory_level_req'] ?? 0,
                        'notes' => $i['notes'] ?? null
                    ])->save();
                }
            }
